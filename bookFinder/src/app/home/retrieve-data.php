            ...
            if($CO[0] == $collection) {
               ...
               if($beginSubjectMatch) {
                  //if(strpos($GLOBALS['CN_ClassNum'], '.') !== false) {
                     if((int)$GLOBALS['CN_ClassNum'] > (int)$GLOBALS['BC_ClassNum']) {
                        $beginMatch = 1;
                     }
                     else if((int)$GLOBALS['CN_ClassNum'] >= (int)$GLOBALS['BC_ClassNum']) {
                        $beginClassMatch = 1;
                     }
                  //}
                  //else {
               ...
               if($endSubjectMatch) {
                  if(strpos($GLOBALS['CN_ClassNum'], '.') !== false) {
                     if((int)$GLOBALS['CN_ClassNum'] < (int)$GLOBALS['EC_ClassNum']) {
                        $endMatch = 1;
                     }
                     else if((int)$GLOBALS['CN_ClassNum'] <= (int)$GLOBALS['EC_ClassNum']) {
                        $endClassMatch = 1;
                     }
                  }
                  else {
